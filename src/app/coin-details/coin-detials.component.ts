...
@Component({
  selector: 'app-coin-detials',
  templateUrl: './coin-detials.component.html',
  styleUrls: ['./coin-detials.component.scss']
})
export class CoinDetialsComponent implements OnInit{
